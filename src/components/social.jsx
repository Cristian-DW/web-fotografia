...
function Social (){
  return (
    <div className=' w-full right-0 bottom-0  fixed bg-fondo2  md:fixed flex justify-evenly items-center md:bottom-1 md:right-5 z-50 md:w-96 h-16   md:bg-transparent  '>
        ...
        <a href="#" className=" px-1 backdrop-blur-2xl">
          <img  className=" hover: button-hover md:h-16 w-auto items-center " src={Red2} alt="logo" />
        </a>
        <a href="#" className=" px-1 backdrop-blur-2xl">
