  ...
  return (
    <div className=' w-full right-0 bottom-0 flex  h-16  fixed bg-fondo2 lg:flex lg:flex-col  lg:fixed justify-evenly items-center lg:bottom-1 lg:right-5 z-50 lg:w-16 lg:h-48   lg:bg-transparent  '>
        ...
        <a href="#" className="px-1 backdrop-blur-2xl  hover:text-red ">
          <img width='auto' height='auto' className=" lg:h-6 w-auto hover: button-hover  " src={Red1} alt="logo" />
        </a>
    
        <a href="#" className=" px-1 backdrop-blur-2xl">
          <img width='auto' height='auto'   className=" hover: button-hover lg:h-6 w-auto items-center " src={Red2} alt="logo" />
        </a>
        <a href="#" className=" px-1 backdrop-blur-2xl">
          <img width='auto' height='auto' className="lg:h-6 w-auto hover: button-hover" src={Red3} alt="logo" />
        </a>
    </div>
  );
};
